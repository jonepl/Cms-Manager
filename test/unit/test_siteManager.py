...
def test_create_site_no_reserverd_ports():
    ...
    assert manager.site.create.called_with("TestProject", { "phpmyadmin": 8000, "wordpress": 9000 })
...
def test_create_site_with_reserverd_ports():
    ...
    assert manager.site.create.called_with("TestProject", { "phpmyadmin": 8005, "wordpress": 9005 })
...
def test_crete_new_project():
    ta = manager.get_site_names()
